<template>
    <div class="main">
        <div class="main-top zoom">
            <div class="lf">首页管理 / <span class="zClr-999">文章/ </span>
                    ...
                    <div class="xbox">
                        <div class="xbox-1 ml15">
                            <div class="sf-font16">
                                ...
                                <span class="rankName" v-if="item.type!=2&&item.nickname!='注销用户'">{{item.rankName}}</span>
                                ...
                                <div class="xbox">
                                    <div class="xbox-1 ml15">
                                        <div class="sf-font16">
                                            ...
                                            <span class="rankName" v-if="items.type!=2&&items.nickname!='注销用户'">{{items.rankName}}</span>
        ...
        methods: {
            ...
            sfConfirm() {
                ...
                if (self.turnBtnState) {
                    ...
                    self.$http.post(self.HOST + '/commentArticle/total', data).then(function(data) {
            ...
            onSelectUser() {
                ...
                if (self.turnBtnState) {
                    self.turnBtnState = false;
                    self.$http.post(self.HOST + '/commentArticle/total').then(function(data) {
                        if (data.data.status === 1) {
                            self.aMaster = data.data.data.master_list;
                            console.log(self.aMaster);
            ...
            sendComment(tag, item, index) {
                ...
                switch (tag) {
                    case "one":
                        data = {
                            type: 1,
                            article_id: self.iCommentActiveID,
            ...
            render() {
                ...
                self.$http.post(self.HOST + '/commentArticle', data).then(function(data) {
                    if (data.data.status == 1) {
