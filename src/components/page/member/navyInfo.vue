<template>
    <div class="sf-main">
        <div class="main-top zoom">
            <div class="pl30 lf">会员用户信息 / <span class="zClr-999">水军详情</span></div>
        </div>
                ...
                <div class="addsset-main">
                    <el-form :model="addMsg" label-width="120px" class="edit">
                        ...
                        <el-form-item label="是否设为水军：">
                            ...
                            <span @click="modification" class=" ml20 sf-memberInfo-btn" >修改</span>
                        </el-form-item>
                        ...
                        <el-form-item class="mt20" label="个人宣传图：" v-if="bGreat">
                            <el-upload action='http://upload-z0.qiniu.com'
                                ...
                                <div class="fl ml10">
                                  ...
                                  <span @click="addPic" type="primary" class="change" style="display:block">{{load}}</span>
    ...
    export default {
        ...
        methods: {
            render() {
                ...
                self.$http.post(self.HOST+'/navy/info/',data).then(function(data){
            ...
            save(){
                ...
                if (self.turnBtnState) {
                    ...
                    self.$http.post(self.HOST + '/navy/upgrade', data).then(function (data) {
                        if (data.data.status == 1) {
                            self.bShow = false;
                            Toast.makeText('修改成功');
                            self.render();
