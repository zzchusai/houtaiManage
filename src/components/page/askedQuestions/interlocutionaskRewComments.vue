                    ...
                    <div class="xbox">
                        <div class="xbox-1 ml15">
                            ...
                            <div class="sf-font14 mt15">
                             ...
                             <!-- <div class='jinxuan set' @click="setjx(index)" v-if="item.choice==1">设为精选</div> -->
                             <!-- <div class="jinxuan cancel" @click="canceljx(index)" v-if="item.choice==2">取消精选</div> -->
                            </div>
                        </div>
                    </div>
                    <!--一级评论发表框-->
...
//            二级回复按钮点击事件
           ...
           render(){
               ...
               if (window.navigator.onLine==false) {
                ...
                self.iCommentActiveID = Number(self.$route.query.id);
                let data = {
                 interlocut_id:self.iCommentActiveID
                };
