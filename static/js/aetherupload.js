...
var AetherUpload = {
    ...
    preprocess: function () { //预处理
        ...
        $.post('/web/aetherupload/preprocess', {
			...
			var radio_url = document.getElementById('radio');
			var fileName = document.getElementById('fileName');
			$(radio_url).text(rst.savedPath);
			$(fileName).text(_this.fileName);
    ...
    uploadChunk: function () {
        ...
        $.ajax({
            ...
            url: "/web/aetherupload/uploading",
